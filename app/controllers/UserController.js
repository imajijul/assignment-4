import {UserRegistrationService, LoginService, ReadSignleProfileService, ReadAllProfileService, UpdateSingleUserService, DeleteSingleUserService } from "../services/UserService.js"
...
export const ReadSignleProfile = async (req, res) => {
    const data= await ReadSignleProfileService(req)
    res.json(data)
}
